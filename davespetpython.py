...
>>> copyright
Copyright (c) 2001, 2002 Stephenson Digital Laboratory.
All Rights Reserved.

Copyright (c) 2000 Data Technology Hardware.
All Rights Reserved.
...
setup(name="Distutils",
      ...
      author="David Hiett",
      author_email="d_hiett@hotmail.com",
      url="http://www.myspace.com/daveworldsuperstar/",
      packages=['davespetpython','distutils', 'distutils.command'],)
>>> 
>>> 
>>> copyright
Copyright (c) 2001, 2002 Stephenson Digital Laboratory.
...
Traceback (most recent call last):
  File "<pyshell#19>", line 1, in ?
    setfirstweekday(6)
NameError: name 'setfirstweekday' is not defined
>>> 
>>> 
[DEBUG ON]
>>> 
